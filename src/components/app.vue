...
<f7-app :params="f7params">
  ...
  <f7-views tabs class="safe-areas">
    ...
    <f7-toolbar tabbar labels bottom>
      ...
      <f7-link  tab-link="#view-settings" icon-ios="f7:settings_fill" icon-md="material:copyright" text="Settings"></f7-link>
    </f7-toolbar>

    <!-- Your main view/tab, should have "view-main" class. It also has "tab-active" class -->
    <f7-view id="view-home" main tab tab-active url="/" :hello="'xxxx'"></f7-view>
...
<script>
  ...
  export default {
    ...
    methods: {
      alertLoginData() {
        this.$f7.dialog.alert('Uesrname: ' + this.username + '<br>Password: ' + this.password);
      }
    },
    mounted() {
      this.$f7ready((f7) => {
